...
CREATE TABLE `cart_product` (
  ...
  CONSTRAINT `fk_cart_product_1` FOREIGN KEY (`product_id`) REFERENCES `product` (`productid`),
  CONSTRAINT `fk_cart_product_2` FOREIGN KEY (`cart_id`) REFERENCES `cart` (`id`)
...
INSERT INTO `cart_product` VALUES (5,1,1,1);
...
INSERT INTO `product` VALUES (1,'Water bottle',2),(2,'Pencil',3);
...
INSERT INTO `user` VALUES (1,'Ishitha','Ishitha','`ishitha',1);
...
-- Dump completed on 2022-05-06  0:12:05
